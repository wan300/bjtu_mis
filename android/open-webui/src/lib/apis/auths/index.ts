...
import { ensureLocalSession, getLocalUser, isLocalFirstClient } from '$lib/local-first';
...
export const guestUserSignUp = async (
	name: string,
	email: string,
	password: string,
	device_id: string
	...
	const res = await fetch(`${WEBUI_API_BASE_URL}/auth/guest/signup`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json'
		},
